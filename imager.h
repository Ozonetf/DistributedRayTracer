...
namespace Imager
{
    ...
    public:
        ...
        int FindClosestIntersection_mt(
        ...
        {
            locallist.clear();
            AppendAllIntersections(vantage, direction, locallist);
    ...
    public:
        ...
        double GetAmbientRefraction()
        {
            return ambientRefraction;
        }
    ...
    private:
        ...
        int FindClosestIntersectionMultiThreaded(
            IntersectionList& locallist,
            const Vector& vantage, 
            const Vector& direction, 
            Intersection& intersection) const;
        ...
        bool HasClearLineOfSightMultiThreaded(
            IntersectionList& locallist,
            const Vector& point1,
            const Vector& point2) const;
        ...
        Color CalculateLightingMultiThreaded(
            IntersectionList& locallist,
            const Intersection& intersection, 
            const Vector& direction, 
            double refractiveIndex,
        ...
        Color CalculateMatteMultithreaded(IntersectionList& locallist, const Intersection& intersection) const;
        ...
        Color CalculateReflectionMultiThreaded(
            IntersectionList& locallist,
            const Intersection& intersection, 
            const Vector& incidentDir, 
            double refractiveIndex,
        ...
        Color CalculateRefractionMultiThreaded(
            IntersectionList& locallist,
            const Intersection& intersection, 
            const Vector& direction, 
            double sourceRefractiveIndex,
