...
namespace Imager
{
...

    {
        ...
        IntersectionList owenstempIntersectionList;

        aSolid.AppendAllIntersections(vantage, direction, owenstempIntersectionList);

        // For each intersection, append to intersectionList 
        // if the point is inside bSolid.
        IntersectionList::const_iterator iter = owenstempIntersectionList.begin();
        IntersectionList::const_iterator end  = owenstempIntersectionList.end();
        for (; iter != end; ++iter)
        {
